      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        ...
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
          ...
          <div className="flex flex-col gap-5 text-white-600 my-5 relative z-10">
            ...
            <p className="grid-subtext animatedText">{currentProject.subdesc}</p>
          </div>

          <div className="flex items-center gap-5 justify-between flex-wrap relative z-10">
            ...
            >
              <p className="grid-subtext">Check Live Site</p>
          ...
          <Canvas>
            ...
            <Center>
              <Suspense fallback={<CanvasLoader />}>
                <group
                  scale={isMobile ? 2.5 : isTablet ? 2.5 : 2.5}
                  position={[-0.5, -3.5, 0]}
                  rotation={[0, -0.1, 0]}
                >
